...
export const emailforChair = ['ahearntu@nih.gov', 'kopchickbp@nih.gov']//, 'ahearntu@nih.gov', 'wraynr@nih.gov']

export const emailforDACC = ['kopchickbp@nih.gov', 'wraynr@nih.gov', 'mukopadhyays2@nih.gov']//,'wraynr@nih.gov',  'garciacm@nih.gov', 'mukopadhyays2@nih.gov']
