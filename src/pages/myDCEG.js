export const myDCEGpublication = () => {
  ...
  <div class="col align-left">
        ...
        <div class="align-left">
             <h1 
            class="page-header">My DCEG Manuscripts
             </h1>
       </div> 
        </div>
          </span>
        <div class="align-left">
          <a href="#uploadinstruction">How to upload data from your published manuscript</a>: Instructions on the steps to upload your data to the DCEG Data Sharing Platform<br> 
