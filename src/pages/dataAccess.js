            ...
            <div class="container body-min-height">
                ...
                <div class="data-submission div-border font-size-18" style="padding-left: 1rem; padding-right: 1rem;">
                    ...
                    <ul>
                        ...
                        Send this email to <a href="mailto:nci_dceg_pdr@nih.gov">nci_dceg_pdr@nih.gov</a> without any modifications. Access for submitting 
                        data requests using the credentials provided in the autogenerated email will be granted within 
                        48 hours of sending the email (excluding weekends). </li>
                    </ul>

                    <b>3) Request access to data</b>
                    <ul>
