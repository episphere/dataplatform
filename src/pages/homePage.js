                ...
                <div class="banner-logo">
                    <div class="banner-overlay-text row justify-content-center text-center">
                        <div class="col-xl-12">
                            ...
                            <h2 class="banner-overlay-h3" style="font-size:2vw;"> FAIR principles in Support of Epidemiological Research
                            </h2>
                        </div>
                    </div>
                </div>
...
export const infoDeckAfterLoggedIn = async () => {
  ...
  template += cardContents({
    header: "Dataset from my DCEG publications",
    button: "Dataset from my DCEG publications",
    href: "#myDCEG",
    icon: "fa-database",
    explanation: "",
  });
